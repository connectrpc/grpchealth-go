...
[![Build](https://connectrpc.com/grpchealth/actions/workflows/ci.yaml/badge.svg?event=push?branch=main)](https://connectrpc.com/grpchealth/actions/workflows/ci.yaml)
